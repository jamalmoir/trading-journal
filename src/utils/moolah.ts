...
export const isCurrencyCode = (val: any): val is CurrencyCode =>
  currencyCodes.includes(<CurrencyCode>val)
...
export class Money {
  ...
  minus = (other: Money) =>
    this._arithmetic((a: Big, b: Big) => a.sub(b), other)
  times = (other: Money | Big) =>
    this._arithmetic((a: Big, b: Big) => a.times(b), other)
  div = (other: Money | Big) =>
    this._arithmetic((a: Big, b: Big) => a.div(b), other)
  pow = (other: Big) =>
    this._arithmetic((a: Big, b: Big) => a.pow(Number(b)), other)
