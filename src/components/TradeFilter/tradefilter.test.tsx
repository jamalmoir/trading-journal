...
describe('<TradeFilter />', () => {
  it('matches snapshot', () => {
    ...
    const component = shallow(
      <TradeFilterComponent onSetTradeFilters={onSetTradeFilters} />
    )
  ...
  it('calls onSetTradeFilters with the right arguments', () => {
    ...
    component
      .find('.trade-filter-instrument')
      .simulate('change', { target: { value: instrument } })
    component
      .find('.trade-filter-strategy')
      .simulate('change', { target: { value: strategy } })
    component
      .find('.trade-filter-kind')
      .simulate('change', { target: { value: kind } })
    component
      .find('.trade-filter-rating')
      .simulate('change', { target: { value: rating } })
    ...
    expect(
      JSON.stringify(onSetTradeFilters.mock.calls[3][0]) ===
