...
export const TradeList = (props: TradeListProps) => {
  return (
    <table
      className={
        props.className + ' trade-list table table-striped table-bordered'
      }
    >
      <thead className={props.className + ' trade-list-item'}>
        <tr>
          <th className="trade-list-item-cell" scope="col">
            Instrument
          </th>
          <th className="trade-list-item-cell" scope="col">
            Strategy
      ...
      <tbody>{buildRows(props.trades)}</tbody>
    </table>
  )
}
