...
!(function() {
  ...
  p &&
    ((X = (v.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      v.readyState
    )) ||
  ...
  ;(gt.prototype = {
    ...
    then: function(t, e) {
      ...
      return (
        (!e && !t) ||
          this._handled ||
          ((this._handled = !0), this._state === tt && nt && ot(ht, this)),
        this._state === $ || this._state === tt
          ? ot(ct, n)
          : this._then.push(n),
        n.then
      )
    ...
    (gt.resolve = function(e) {
      return e && 'object' === i(e) && e.constructor === gt
        ? e
        : new gt(function(t) {
            t(e)
          })
  ...
  function jt(t) {
    var e = t.icons,
      ...
      g = [
        J.replacementClass,
        i ? ''.concat(J.familyPrefix, '-').concat(i) : '',
        h,
      ]
        .filter(function(t) {
      ...
      X =
        a.found && n.found
          ? ((w = (b = q).children),
            ...
            (P = A.width),
            (N = A.icon),
            (M = Mt({ transform: C, containerWidth: P, iconWidth: O })),
            (z = { tag: 'rect', attributes: K({}, zt, { fill: 'white' }) }),
            (E = S.children ? { children: S.children.map(Et) } : {}),
            (j = {
              tag: 'g',
              attributes: K({}, M.inner),
              children: [
                Et(
                  K({ tag: S.tag, attributes: K({}, S.attributes, M.path) }, E)
                ),
              ],
            }),
            (L = { tag: 'g', attributes: K({}, M.outer), children: [j] }),
            (R = 'mask-'.concat(kt())),
            (_ = 'clip-'.concat(kt())),
            (T = {
              tag: 'mask',
  ...
  function Lt(t) {
    ...
    Nt(r) &&
      ((y.transform =
        ((u = (f = { transform: r, startCentered: !0, width: n, height: a })
          .transform),
        (d = f.width),
        (m = void 0 === d ? A : d),
        (p = f.height),
        ...
        (b +=
          (v = void 0 !== g && g) && k
            ? 'translate('
                .concat(u.x / bt - m / 2, 'em, ')
                .concat(u.y / bt - h / 2, 'em) ')
            : v
            ? 'translate(calc(-50% + '
                .concat(u.x / bt, 'em), calc(-50% + ')
                .concat(u.y / bt, 'em)) ')
            : 'translate('.concat(u.x / bt, 'em, ').concat(u.y / bt, 'em) ')),
        (b += 'scale('
          .concat((u.size / bt) * (u.flipX ? -1 : 1), ', ')
          .concat((u.size / bt) * (u.flipY ? -1 : 1), ') ')),
  ...
  var Rt = function() {},
    _t =
      J.measurePerformance && f && f.mark && f.measure
        ? f
        : { mark: Rt, measure: Rt },
    Tt = 'FA "5.11.2"',
    It = function(t) {
      _t.mark(''.concat(Tt, ' ').concat(t, ' ends')),
        _t.measure(
          ''.concat(Tt, ' ').concat(t),
          ''.concat(Tt, ' ').concat(t, ' begins'),
          ''.concat(Tt, ' ').concat(t, ' ends')
        )
    },
    Yt = {
      begin: function(t) {
        return (
          _t.mark(''.concat(Tt, ' ').concat(t, ' begins')),
          function() {
            return It(t)
          }
        )
  ...
  function Jt(t) {
    return t.reduce(function(t, e) {
      ...
      if (Kt[e]) t.prefix = e
        ...
        var a =
          'fa' === t.prefix ? Xt[n] || { prefix: null, iconName: null } : {}
  ...
  var ee = {
    ...
    nest: function(t) {
      ...
      var r = n[0].attributes.class.split(' ').reduce(
        function(t, e) {
          return (
            e === J.replacementClass || e.match(a)
              ? t.toSvg.push(e)
              : t.toNode.push(e),
            t
          )
      ...
      J.mutateApproach === P && (e = g.requestAnimationFrame || ne),
        e(function() {
          var t =
              !0 === J.autoReplaceSvg
                ? ee.replace
                : ee[J.autoReplaceSvg] || ee.replace,
            e = Yt.begin('mutate')
          n.map(t), e(), a()
        })
    }
          ...
          At(t).forEach(function(t) {
            if (
              ('childList' === t.type &&
                ...
                !te(t.addedNodes[0]) &&
                (J.searchPseudoElements && o(t.target), r(t.target)),
              'attributes' === t.type &&
                t.target.parentNode &&
  ...
  function se(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix &&
          1 === i.length &&
          (o.iconName = Vt(o.prefix, Ht(t.innerText))),
      o
    )
  }
  var le = function(t) {
  ...
  function fe(t) {
    ...
    return {
      ...
      symbol: p,
      mask: g,
      extra: { classes: u, styles: d, attributes: h },
    }
  }
  function ue(t) {
  ...
  var de = { fill: 'currentColor' },
    ...
    ge = {
      ...
      children: [
        ...
        {
          tag: 'circle',
          attributes: K({}, de, { cx: '256', cy: '364', r: '28' }),
          children: [
            {
              tag: 'animate',
              attributes: K({}, me, {
            ...
            {
              tag: 'animate',
              attributes: K({}, he, { values: '1;0;1;1;0;1;' }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: 'animate',
              attributes: K({}, he, { values: '1;0;0;0;0;1;' }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: 'animate',
              attributes: K({}, he, { values: '0;0;1;1;0;0;' }),
            },
          ],
        },
      ],
    ...
    return new vt(function(a, t) {
      ...
      if (r) {
        var o = n.getPropertyValue('content'),
          c = ~['Solid', 'Regular', 'Light', 'Duotone', 'Brands'].indexOf(r[1])
            ? E[r[1].toLowerCase()]
            : R[i],
  ...
  var Le,
      ...
      ((Le = function(t) {
        ...
        if (t) {
          var g = t.prefix,
            v = t.iconName,
            b = t.icon
          return Ee(K({ type: 'icon' }, t), function() {
            return (
              ze(),
              J.autoA11y &&
                (l
          ...
          return (
            ...
            (function(t) {
              ...
              extra: {
                attributes: c,
                styles: l,
                classes: [''.concat(J.familyPrefix, '-layers-counter')].concat(
                  m(i)
                ),
              },
            })
    ...
    Fe = function() {
      var t = (0 < arguments.length && void 0 !== arguments[0]
        ...
        e = void 0 === t ? v : t
      ;(0 < Object.keys(W.styles).length || J.autoFetchSvg) &&
        p &&
        J.autoReplaceSvg &&
        Ye.dom.i2svg({ node: e })
    }
  !(function(t) {
    ...
    u &&
      (g.FontAwesome || (g.FontAwesome = Ye),
      B(function() {
        Fe(),
          ce({ treeCallback: ke, nodeCallback: Ae, pseudoElementsCallback: Pe })
      })),
      (W.hooks = K({}, W.hooks, {
