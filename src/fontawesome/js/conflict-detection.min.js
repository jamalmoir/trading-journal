...
;(e = this),
  (t = function(e) {
    ...
    s &&
      ((d = (u.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
        u.readyState
      )) ||
          ...
          !(function(e) {
                  ...
                  (s = g(
                    (s = g(
                          ...
                          (s = h(
                            (s = h(
                              ...
                              (f = h(
                                ...
                                (l = h(
                                  l,
                                  (a = h(a, s, f, l, e[n + 1], 4, -1530992060)),
                                  s,
                                  f,
                                  e[n + 4],
                                  11,
                            ...
                            (f = h(
                              ...
                              (l = h(
                                l,
                                (a = h(a, s, f, l, e[n + 13], 4, 681279174)),
                                s,
                                f,
                                e[n],
                                11,
                      ...
                      (f = g(
                        ...
                        (l = g(
                          l,
                          (a = g(a, s, f, l, e[n + 12], 6, 1700485571)),
                          s,
                          f,
                          e[n + 3],
                          10,
                    ...
                    (f = g(
                      ...
                      (l = g(
                        l,
                        (a = g(a, s, f, l, e[n + 8], 6, 1873313359)),
                        s,
                        f,
                        e[n + 15],
                        10,
            ...
            function i(e, t) {
              return (function(e, t) {
                ...
                for (
                  i[15] = c[15] = void 0,
                    16 < r.length && (r = s(r, 8 * e.length)),
                    n = 0;
                  n < 16;
                  n += 1
                )
                  (i[n] = 909522486 ^ r[n]), (c[n] = 1549556828 ^ r[n])
                return (
                  (o = s(i.concat(l(t)), 512 + 8 * t.length)),
                  f(s(c.concat(o), 640))
                )
              })(n(e), n(t))
            }
    ...
    function C() {
      ...
      l.onmessage = function(e) {
        ;('file://' !== l.location.origin && e.origin !== l.location.origin) ||
          (e &&
            e.data &&
      ...
      var e = (function(t) {
          for (
            var c = Array.from(u.scripts).filter(function(e) {
              ...
              e = function(e) {
                ...
                n.setAttribute(w, o),
                  (a[o] = c[e]),
                  '' !== c[e].src && (n.src = c[e].src),
                  '' !== c[e].innerText && (n.innerText = c[e].innerText),
                  (n.async = !0)
        ...
        o = (function() {
          var e = Array.from(u.getElementsByTagName('link')).filter(function(
              e
            ) {
              ...
              return !(
                ...
                (l.FontAwesomeConfig &&
                  e.innerText.match(
                    new RegExp(
                      'svg:not\\(:root\\)\\.'.concat(
                        l.FontAwesomeConfig.replacementClass
                      )
                    )
                  ))
              )
                ...
                function(n, o, r, i) {
                  parent.FontAwesomeDetection.__pollUntil({
                    fn: function() {
                      ...
                      return !(
                        !t.match(/FontAwesome/) && !t.match(/Font Awesome 5/)
                      )
                    },
                  })
                    .then(function() {
        ...
        c =
          l.FontAwesomeDetection.timeout +
          l.FontAwesomeDetection.resultsCollectionMaxWait
          ...
          : (console.info('Testing '.concat(i, ' possible conflicts.')),
            console.info(
              "We'll wait about ".concat(
                Math.round(l.FontAwesomeDetection.timeout / 10) / 100,
                ' seconds while testing these and\n'
              ) +
                'then up to another '.concat(
                  Math.round(
                    l.FontAwesomeDetection.resultsCollectionMaxWait / 10
                  ) / 100,
        ...
        {},
        {
          report: function(e) {
            ...
            if (0 < f) {
              console.info(
                '%cNo conflict'
                  .concat(1 < f ? 's' : '', ' found with ')
                  .concat(1 == f ? 'this' : 'these', ':'),
          ...
          resultsCollectionMaxWait: +(
            u.currentScript.getAttribute(T) || '5000'
          ),
        },
        F,
        {
  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(['exports'], t)
    : t((e['fontawesome-free-conflict-detection'] = {}))
