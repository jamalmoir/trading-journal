...
describe('journal actions', () => {
  ...
  it('shows all trades belonging to a journal belonging to a user with no filters', () => {
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({}) },
    }
  ...
  it('filters by intrument correctly', () => {
    state = {
      ...
      trade: {
        ...state.trade,
        tradeFilters: getFilters({ instrument: 'GBPJPY' }),
      },
    }
  ...
  it('it filters by strategy correctly', () => {
    ...
    state = {
      ...
      trade: {
        ...state.trade,
        tradeFilters: getFilters({ strategy: 'Strategy 2' }),
      },
    }
  ...
  it('it filters by kind correctly', () => {
    ...
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ kind: 'long' }) },
    }
    expect(checkTrades(getFilteredTrades(state), ['1'])).toBeTruthy()
  })
  ...
  it('it filters by rating correctly', () => {
    ...
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ rating: -1 }) },
    }
    expect(checkTrades(getFilteredTrades(state), ['2'])).toBeTruthy()
  })
  ...
  it('it filters by entry date correctly', () => {
    ...
    state = {
      ...
      trade: {
        ...state.trade,
        tradeFilters: getFilters({ entryDate: new Date('2019/10/31') }),
      },
    }
  ...
  it('it filters by exit date correctly', () => {
    ...
    state = {
      ...
      trade: {
        ...state.trade,
        tradeFilters: getFilters({ exitDate: new Date('2019/10/31') }),
      },
    }
    expect(checkTrades(getFilteredTrades(state), ['2'])).toBeTruthy()
  })
  ...
  it('it filters by profit correctly', () => {
    ...
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ profit: true }) },
    }
    expect(checkTrades(getFilteredTrades(state), ['1'])).toBeTruthy()
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ profit: false }) },
    }
    expect(checkTrades(getFilteredTrades(state), ['2'])).toBeTruthy()
  })
  ...
  it('it filters by hit take profit correctly', () => {
    ...
    state = {
      ...
      trade: {
        ...state.trade,
        tradeFilters: getFilters({ hitTakeProfit: true }),
      },
    }
    expect(checkTrades(getFilteredTrades(state), ['1'])).toBeTruthy()
    state = {
      ...
      trade: {
        ...state.trade,
        tradeFilters: getFilters({ hitTakeProfit: false }),
      },
    }
    expect(checkTrades(getFilteredTrades(state), ['2'])).toBeTruthy()
  })
  ...
  it('it filters by flagged correctly', () => {
    ...
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ flagged: true }) },
    }
    expect(checkTrades(getFilteredTrades(state), ['2'])).toBeTruthy()
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ flagged: false }) },
    }
  ...
  it('it filters by managed correctly', () => {
    ...
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ managed: true }) },
    }
    expect(checkTrades(getFilteredTrades(state), [])).toBeTruthy()
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ managed: false }) },
    }
    expect(checkTrades(getFilteredTrades(state), [])).toBeTruthy()
  })
  ...
  it('it filters by tags correctly', () => {
    ...
    state = {
      ...state,
      trade: { ...state.trade, tradeFilters: getFilters({ tags: ['monday'] }) },
    }
    expect(checkTrades(getFilteredTrades(state), ['1'])).toBeTruthy()
  })
  ...
  it('it filters by emotions correctly', () => {
    ...
    state = {
      ...
      trade: {
        ...state.trade,
        tradeFilters: getFilters({ emotions: ['rushed'] }),
      },
    }
    expect(checkTrades(getFilteredTrades(state), ['2', '3'])).toBeTruthy()
  })
